<div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @else
                ...
                <div class="mt-5 p-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                    ...
                    @empty 
                        ...
                        <div class="md:col-span-2 lg:col-span-3 text-gray-400 pt-20">
                            ...
                            <p class="text-lg text-center mt-8">
                                @if($category)
                                    No tasks in <span class="uppercase font-medium">{{ config('tasks.categories.'.$category.'.label') }}</span> category.
                                @else
