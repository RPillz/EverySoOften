<div class="bg-green-200 border-t-2 border-green-600 p-10 flex items-center justify-between">

    <x-icon name="clock" class="text-green-600 w-12 h-12" />

    <div class="text-lg text-center text-green-800 font-black">
        <p class="uppercase">Next Reminder</p> 
